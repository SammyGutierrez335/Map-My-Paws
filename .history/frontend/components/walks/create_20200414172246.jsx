...
import { createWaypoint } from "../../actions/waypoint_action"
...
class Walk extends React.Component {
    ...
    saveWalk() {
        this.state.waypoints.forEach(waypoint => {
            this.props.createWaypoint({walk_id: 1, latitude: waypoint[0], longitude: waypoint[1]})
        })
...
export default connect(null, mDTP)(Walk) 
